...
## ----libs, echo=FALSE, message=FALSE, results='hide'--------------------------
library(DT)
...
## ----setup, fig.height = 10, fig.width = 12, fig.align = "center"-------------
library(JoesFlow)
run_app()
...
## ----pca, fig.height = 10, fig.width = 12, fig.align = "center"---------------

cluster_pca(sample_data, meta_data, 10)


## ----umap, fig.height = 10, fig.width = 12, fig.align = "center"--------------

cluster_umap(sample_data, meta_data, 10)


## ----comp_plot, fig.height = 6, fig.width = 8, fig.align = "center"-----------

composition_plot(sample_data, meta_data, 15)


## ----heat_plot, fig.height = 10, fig.width = 12, fig.align = "center"---------
